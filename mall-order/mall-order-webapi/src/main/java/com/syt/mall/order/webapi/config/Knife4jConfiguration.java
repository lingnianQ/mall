...
public class Knife4jConfiguration {
     ...
     * 分组名称
     */
    private final String groupName = "base-order";
    /**
     * 主机名
     */
     ...
     * 标题
     */
    private final String title = "order项目案例在线API文档--基础order-web实例";
    /**
     * 简介
     */
    private final String description = "构建基础order-web项目,实现订单功能";
    /**
     * 服务条款URL
     */
