...
public class Knife4jConfiguration {
     ...
     * 【重要】指定Controller包路径
     */
    private final String basePackage = "com.syt.mall.cart.webapi.controller";
    /**
     * 分组名称
     */
    private final String groupName = "base-cart";
    /**
     * 主机名
     */
     ...
     * 标题
     */
    private final String title = "cart项目案例在线API文档--基础cart-web实例";
    /**
     * 简介
     */
    private final String description = "构建基础cart-web项目,实现购物车功能";
    /**
     * 服务条款URL
     */
